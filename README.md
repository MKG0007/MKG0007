...
<table align="center" width="100%" cellspacing="15" cellpadding="0" style="border-collapse: separate; border-spacing: 15px;">
  <tr>
    <!-- LeetCode -->
    <td style="border: 2px solid white; border-radius: 12px; padding: 0; background-color: #0d1117; vertical-align: middle; text-align:center; width:50%;">
  ...
  <tr>
    ...
    <td style="border: 2px solid white; border-radius: 12px; padding: 10px; background-color:#0d1117; text-align:center; width:50%;">
      ...
      <div style="display:flex; justify-content:center; flex-wrap:wrap; gap:8px; width:100%; padding:5px;">
        <!-- Badges -->
    ...
    <!-- Github Streak -->
    <td style="border: 2px solid white; border-radius: 12px; padding:0; background-color:#0d1117; text-align:center; width:50%;">
